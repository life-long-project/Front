...
import processImage1 from "../../../assests/images/process-01.png";
import processImage2 from "../../../assests/images/process-02.png";
import processImage3 from "../../../assests/images/process-03.png";
          ...
          <Row className="align-items-center">
            ...
            <Col lg={6}>
              <TabContent activeTab={activeTab}>
                <TabPane tabId="1">
                  <img src={processImage1} alt="" className="img-fluid ps-5" />
                </TabPane>
                <TabPane tabId="2">
                  <img src={processImage2} alt="" className="img-fluid ps-5" />
                </TabPane>
                <TabPane tabId="3">
                  <img src={processImage3} alt="" className="img-fluid ps-5" />
                </TabPane>
              </TabContent>
            </Col>
          </Row>
