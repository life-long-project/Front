            ...
            {(categories || []).map((item, key) => (
              <Col lg={3} md={6} mt={4} pt={2} key={key}>
                <div className="popu-category-box rounded text-center">
                  <div className="popu-category-icon icons-md d-flex justify-content-center align-items-center">
                    <Icon icon={item.icon} className="purbleTxt" />
                  </div>
          ...
          <Row>
            <Col lg={12}>
              <div className="mt-5 text-center">
                <Link
                  to="/jobscategories"
                  className="purbleBtn btn btn-primary btn-hover hvr-bob"
                >
