...
export default function JobDetails() {
  ...
  async function getJobDetails(id) {
    let { data } = await axios.get(`https://back-ph2h.onrender.com/jobs/${id}`);
    setJobDetails(data);
  }
        ...
        <div className="col-md-8">
          <div className="row bg-white mb-3 p-4">
            <div className="col-10">
              ...
              <p className="card-text mb-2">
                ...
                -{" "}
                <span className="text-muted">{jobDetails.job_location_id}</span>
              </p>
          ...
          <div className="row bg-white mb-3 p-4">
            <div className="col-md-8 bg-white">
              <h3 className="text-capitalize fw-bold mb-3">job description</h3>
